...
insert into `kunde` values('1','Mustermann','Max','Hauptstrasse','8','8000','Zürich','CH','044 44 44 444','Max@Musermann.ch'),
 ('2','Wyss','Kim','Hauptstrasse','88','4000','Basel','CH','061 44 44 444','Kim@Wyss.ch');
...
CREATE TABLE `bestellung` (
  ...
  `kreditkartemonat` int(11) default NULL,
